...
To allow for this, EACirc is capable of saving and loading its entire internal state to a set of XML-structured files.
...
\end{itemize}
\noindent
The \textsc{dot} graph format can be easily displayed using the Graphviz library \cite{graphviz} and thus 
...
The independence of this process is of utmost importance, since it provides supporting evidence for the reached results.
