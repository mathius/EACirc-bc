...
% transcendental khaoblack metal (music)
...
\multicolumn{2}{l||}{} & \rotatedHeader{random\\stream 1} & \rotatedHeader{random\\stream 2} & \rotatedHeader{random\\stream 2} & 
\rotatedHeader{white noise} & \rotatedHeader{pink noise} & \rotatedHeader{brown noise} & 
\rotatedHeader{white noise\\(oscillating)} & \rotatedHeader{pink noise\\(oscillating)} & \rotatedHeader{brown noise\\(oscillating)} & 
\rotatedHeader{metal music\\(sample 1)} & \rotatedHeader{metal music\\(sample 2)} & \rotatedHeader{metal music\\(sample 3)} \\ \cline{3-14} \hline \hline
\multirow{3}{*}[-20pt]{\rotatedHeader{random}} &
 random stream 1 & (0.52) & (0.52) & (0.91) & (0.96) & (0.97) & (0.87) & (0.93) & (0.95) & (0.79) & (0.84) & (0.88) \\ \cline{2-14}
& random stream 2 & & & & & & & & & & & & \multicolumn{1}{l}{} \\ \cline{2-13}
& random stream 3 & & & & & & & & & & & \multicolumn{2}{l}{} \\ \cline{1-12}
\multirow{3}{*}[-20pt]{\rotatedHeader{noise}} & 
\raisebox{-8pt}{white noise} & & & & & & & & & & \multicolumn{3}{l}{} \\[14pt] \cline{2-11}
& \raisebox{-8pt}{pink noise} & & & & & & & & & \multicolumn{4}{l}{} \\[14pt] \cline{2-10}
& \raisebox{-8pt}{brown noise} & & & & & & & & \multicolumn{5}{l}{} \\[14pt] \cline{1-9}
\multirow{3}{*}[-10pt]{\rotatedHeader{noise (osc.)}} & 
white noise (oscillating) & & & & & & & \multicolumn{6}{l}{} \\ \cline{2-8}
& pink noise (oscillating) & & & & & & \multicolumn{7}{l}{} \\ \cline{2-7}
& brown noise (oscillating) & & & & & \multicolumn{8}{l}{} \\ \cline{1-6}
\multirow{3}{*}[-5pt]{\rotatedHeader{metal music}} & 
metal music (sample 1) & & & & \multicolumn{9}{l}{} \\ \cline{2-5}
& metal music (sample 2) & & & \multicolumn{10}{l}{} \\ \cline{2-4}
& metal music (sample 3) & & \multicolumn{11}{l}{} \\ \cline{1-3}
%\multicolumn{3}{|c|}{random streams}
\end{tabularx}
