...
\usepackage[backend=biber,bibstyle=ieee-alphabetic,citestyle=alphabetic,url=true,hyperref=auto,block=ragged,abbreviate=true
]{biblatex}
...
the Laboratory of Security and Applied Cryptography, Masaryk University \parencite{labak} and was loosely based on SensorSim,
