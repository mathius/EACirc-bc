...
It definitely implies a possible design flaw in Salsa20 influencing the randomness of every 7\textsuperscript{th} output byte.
...
\begin{myItemize}
\item \texttt{eacirc}\\
source codes of EACirc (copy of entire project repository with master commit 4b92ed9e36 from 2013-05-19)
\item \texttt{eacirc-wiki}\\
project's wiki-based documentation (copy of entire wiki repository with master commit 2817031fac from 2013-05-05)
