...
\newcolumntype{C}{>{\centering\arraybackslash}X}%
\begin{tabularx}{7cm}{|r||S[table-format=2.1]|S[table-format=3.0]|C|} \hline
...
statistical randomness testing, random distinguisher, evolutionary algorithms, genetic programming, software circuit, 
...
Notice the asterisk in Dieharder results in \autoref{tab:sha3-dch} which indicates 4 test got stuck by
the input data, effectively reducing the number of tests to 16 (situation similar to \autoref{tab:estream-tsc}).
...
\resultsTableSha{
0 & 0.0 &  & $n=604$ \\ \hline
1 & 0.0 &  & $n=1073$ [29] \\ \hline
2 & 0.0 &  & $n=2074$ \\ \hline
3 & 0.0 &  & $n=3735$ [29] \\ \hline
4 & 0.0 &  &  \\ \hline
5 & 0.0 &  &  \\ \hline
6 &  &  &  \\ \hline \hline
8 & 20.0 &  & (0.52) \\ \hline
...
%\resultsTableSha{
%0 &  &  & $n=1171$ \\ \hline
%1 &  &  & $n=5631$ \\ \hline \hline
%2 &  &  & (0.52) \\ \hline
%}
%\caption{Random distinguishers for WaMM output.}
%\label{tab:sha3-wamm}
}
\end{table}
